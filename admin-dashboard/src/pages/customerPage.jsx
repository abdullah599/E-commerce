       ...
       <div class="flex flex-row justify-between w-full mb-1 sm:mb-0">
         ...
         <div class="text-end">
           <form class="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
             ...
             <button
               class="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-[color:var(--background-color-1)] rounded-lg shadow-md hover:bg-[color:var(--background-color-2)] focus:outline-none focus:ring-2 focus:ring-[color:var(--background-color-1)] focus:ring-offset-2 focus:ring-offset-[color:var(--background-color-1)] "
               type="submit"
             >
               Filter
             </button>
